export const messages = {
  en: {
    ...
    missingPaneId: 'tmux split-window did not report a pane ID.',
    nodeUnavailable: 'The DAG viewer requires Node.js 24 or later. Install node on PATH or set OMO_TMUX_DAG_NODE to a Node executable path, then run /dag-pane again.',
    ...
    unmanagedDirectory: 'This directory is not managed by omo-tmux-dag: {path}',
  ...
  ko: {
    ...
    missingPaneId: 'tmux split-window 응답에 pane ID가 없습니다.',
    nodeUnavailable: 'DAG viewer에는 Node.js 24 이상이 필요합니다. PATH에 node를 설치하거나 OMO_TMUX_DAG_NODE에 Node 실행 파일 경로를 지정한 뒤 /dag-pane을 다시 실행하세요.',
